...
The top of the routing tree for the **{{PROJECT_NAME}}** context system. **Directory-level
...
| **traceability/** | full | The IMPL→WIRED ledger — production-reachability proof per work-unit | [traceability/index.md](./traceability/index.md) |
| **dispatch-charters/** | full | Single-owner dispatch charters (`FR-NNNN`) + wave-plan ledger | [dispatch-charters/index.md](./dispatch-charters/index.md) |
| **research/** | full | One `research/<R-id>/` dir per adversarially-gated investigation | [research/index.md](./research/index.md) |
| **runbooks/** | full | Operational procedures; read end-to-end before running | [runbooks/index.md](./runbooks/index.md) |
| **incidents/** | full | Post-mortems, date-prefixed; genealogy feeds `lessons/` + rules | [incidents/index.md](./incidents/index.md) |
| **experiments/** | full | Spikes / probes with captured outcome (the throwaway-spike home) | [experiments/index.md](./experiments/index.md) |
